...
public class BandaRockInterface extends JFrame {
	...
	public BandaRockInterface() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("X:\\Universidad Mariana\\Septimo Semestre\\Estructuras de datos\\BandasDeRock-JSP-MySQL\\BandasRock\\misImagenes\\icono1.png"));
		...
		btnAgregar.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent arg0) {
				...
				btnAgregar.setForeground(new Color(250, 240, 230));
				...
				try { // -- Establecer conexion
					...
					if (resultado > 0   ) {
						JOptionPane.showMessageDialog(null,
								"La Banda " + txtNombre.getText() + " ha sido agregado correctamente bebe ");
						conexion.close();
					} else
		...
		btnBuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnBuscar.setForeground(new Color(250, 240, 230));
			...
			public void actionPerformed(ActionEvent e) {
				...
				try { // -- Establecer conexion
					...
					if (resulSet.next())
					{
						...
						//lblFotoBanda.setIcon(new ImageIcon("imagen_banda" ));
		...
		btnModificar.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent arg0) {
				...
				btnModificar.setText(" BANDA ");
				btnModificar.setFont(new Font("Rockwell Condensed", Font.BOLD, 16));
				
				btnModificar.setBackground(new Color(0, 0, 51));
				btnModificar.setForeground(new Color(250, 240, 230));
			...
			public void mouseExited(MouseEvent e) {
				...
				btnModificar.setFont(new Font("Rockwell Condensed", Font.BOLD, 15));
				
				btnModificar.setBackground(SystemColor.scrollbar);
		...
		btnBorrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnBorrar.setText(" BANDA ");
				btnBorrar.setFont(new Font("Rockwell Condensed", Font.BOLD, 16));
				
				btnBorrar.setBackground(new Color(0, 0, 51));
				btnBorrar.setForeground(new Color(250, 240, 230));
			...
			public void mouseExited(MouseEvent e) {
				...
				btnBorrar.setFont(new Font("Rockwell Condensed", Font.BOLD, 15));
		...
		txtImagen.setForeground(new Color(250, 240, 230));
		...
		txtCantidadCanciones.setForeground(new Color(250, 240, 230));
		...
		txtCantidadCanciones.setOpaque(false);
		...
		txtAlbum.setForeground(new Color(250, 240, 230));
		...
		txtVocalista.setForeground(new Color(250, 240, 230));
		...
		txtVocalista.setOpaque(false);
		
		JLabel lblVocalista = new JLabel("Vocalista");
		lblVocalista.setForeground(new Color(153, 0, 204));
		...
		txtNombre.setForeground(new Color(250, 240, 230));
		...
		lblFondo.setIcon(new ImageIcon("X:\\Universidad Mariana\\Septimo Semestre\\Estructuras de datos\\BandasDeRock-JSP-MySQL\\BandasRock\\misImagenes\\imagen16.gif"));
